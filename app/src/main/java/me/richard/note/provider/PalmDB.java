package me.richard.note.provider;
 ...
 *
 * 1. Extends {@link me.richard.note.model.Model} to add model;
 * 2. Implement {@link me.richard.note.provider.schema.BaseSchema} to add schema;
 * 3. Extends {@link BaseStore} to add store;
 * 4. Modify {@link me.richard.note.model.enums.ModelType} to register model type;
 * 5. Modify {@link me.richard.note.provider.helper.TimelineHelper} to enable in time line;
 * 6. Modify {@link me.richard.note.model.ModelFactory} to add model factory.
 *
 * Others:
 * 7. Extends {@link me.richard.note.viewmodel.BaseViewModel} to add view mode;
