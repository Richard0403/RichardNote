...
import me.richard.note.adapter.CategoriesAdapter;
import me.richard.note.databinding.FragmentCategoriesBinding;
...
import me.richard.note.widget.tools.CustomItemAnimator;
import me.richard.note.widget.tools.CustomItemTouchHelper;
...
public class CategoriesFragment extends BaseFragment<FragmentCategoriesBinding> implements
    ...
    public void reload() {
        if (getActivity() instanceof OnCategoriesInteractListener) {
            ((OnCategoriesInteractListener) getActivity()).onCategoryLoadStateChanged(
                    me.richard.note.model.data.Status.LOADING);
        }
    ...
    public interface OnCategoriesInteractListener {
        ...
        default void onCategoryLoadStateChanged(me.richard.note.model.data.Status status) {}
    }
}