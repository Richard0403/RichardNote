...
public class ScreenUtils {
    ...
    public static int getScreenWidth() {
        return PalmApp.getContext().getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return PalmApp.getContext().getResources().getDisplayMetrics().heightPixels + getNavigationBarHeight();
    }

    private static int getNavigationBarHeight() {
        int height = 0;
        if(SystemInfo.checkDeviceHasNavigationBar(PalmApp.getContext())){
            Resources resources = PalmApp.getContext().getResources();
    ...
    public static float dpToPx(float dp) {
        return dp * PalmApp.getContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / PalmApp.getContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / PalmApp.getContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * PalmApp.getContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static int getWindowHeight(Context context){
        return getScreenHeight()  - getNavigationBarHeight() - getStatusBarHeight(context);
    }
    ...
    private int getStatusBarHeight() {
        ...
        try {
            ...
            sbar = PalmApp.getContext().getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
        return sbar;
    ...
    public static int getScreenBrightnessInt255() {
        ...
        try {
            screenBrightness = Settings.System.getInt(PalmApp.getContext().getContentResolver(), Settings.System.SCREEN_BRIGHTNESS);
        } catch (Exception e) {
            e.printStackTrace();
        }
