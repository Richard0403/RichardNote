...
public class SystemInfo {
    ...
    public static boolean isMainProcess() {
        ...
        if(PalmApp.getContext() == null || TextUtils.isEmpty(getAppName(PalmApp.getContext(), pid))){
            return false;
        }

        return getAppName(pid).equalsIgnoreCase(PalmApp.getContext().getPackageName());
    }

    public static String getAppName(int pid) {
        String processName = null;
        ActivityManager am = (ActivityManager) PalmApp.getContext().getSystemService(PalmApp.getContext().ACTIVITY_SERVICE);
        List l = am.getRunningAppProcesses();
        Iterator i = l.iterator();
        PackageManager pm = PalmApp.getContext().getPackageManager();
        while (i.hasNext()) {
